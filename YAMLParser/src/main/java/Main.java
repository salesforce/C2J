...
public class Main {
    ...
    static final String OUTPUT = String.format("%s/../Model/src/main/java/Model/Autogenerated/", System.getProperty("user.dir"));
    ...
    public static void main(String[] args) {
        ...
        try {
            Map<String, String> javaClasses =
                    p.Parse(Objects.requireNonNull(yamlObjectDataModel),AUTOGENERATED_PACKAGE_NAME);
